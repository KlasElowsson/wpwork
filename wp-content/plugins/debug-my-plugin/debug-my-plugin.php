...
class DebugMyPlugin {
    ...
    function DebugMyPlugin() {
        ...
        // Move Debug Bar processing to way down at the end of the call stack.
        //
        // This needs to be here or it misses a bunch of stuff after wp_after_admin_bar_render
        // is called, which is VERY EARLY in the process.   I move this function to the shutdown
        // call.
        //

        // Skip this for AJAX Stuff, if configured
        //
        if (!defined('DOING_AJAX') || !DOING_AJAX) {
            add_action(     'shutdown'                  , array( $GLOBALS['debug_bar'], 'render' ) );
        }
    }
    ...
    function addMyPanel($panels) {
        remove_action(  'wp_after_admin_bar_render' , array( $GLOBALS['debug_bar'], 'render' ) );
