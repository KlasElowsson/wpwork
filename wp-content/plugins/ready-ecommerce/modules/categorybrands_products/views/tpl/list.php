<div class="toeWidget">
    ...
    <?php }?>
    <div id="toeCBPWidgetContent<?php echo $this->uniqID?>">
        <div class="categorybrands_products">
            <?php if (!empty($this->products)):
                    foreach ($this->products as $product) :?>
            <div class="categorybrands_product">
                <div class="categorybrands_product_wrapper">
