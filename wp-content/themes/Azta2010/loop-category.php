...
<?php $annons_cnt++ ;?>
	...
	<?php endif; ?>
			...
			<div class="entry-utility">
				<!-- klas <?php if ( count( get_the_category() ) ) : ?>
				...
				<!-- klas<?php
					...
					if ( $tags_list ):
				?>-->
					<!-- klas <span class="tag-links">
						<?php printf( __( '<span class="%1$s">Tagged</span> %2$s', 'twentyten' ), 'entry-utility-prep entry-utility-prep-tag-links', $tags_list ); ?>
					</span> -->
					<!-- klas <span class="meta-sep">|</span>-->
				<?php endif; ?>
				<!-- klas <span class="comments-link"><?php comments_popup_link( __( 'Leave a comment', 'twentyten' ), __( '1 Comment', 'twentyten' ), __( '% Comments', 'twentyten' ) ); ?></span>-->
				<!-- klas <?php edit_post_link( __( 'Edit', 'twentyten' ), '<span class="meta-sep">|</span> <span class="edit-link">', '</span>' ); ?>-->
			</div><!-- .entry-utility -->
		</div><!-- #post-## -->

<!-- klas		<?php comments_template( '', true ); ?>-->
